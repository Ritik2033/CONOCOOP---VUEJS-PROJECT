<template>
    <v-main>
        <div class="table-wrapper">
            <div class="header">
               <h1 class="Asociación-lines-title">{{ $t('associationFeature') }}</h1>


                <!-- Adding a button here -->
               <button class="top-button" @click="showModal = true">{{ $t('addFeature') }}</button>
                ...
                <div v-if="showModal" class="modal-overlay">
                    <div class="modal">
                        ...
                        <div class="form-group">
                            ...
                            <input class="class4" type="text" id="AsociaciónName"
                                :placeholder="$t('Association_Line_Name_Placeholder')">
                        </div>

                        <div class="form-group">
                            <label class="class5" for="AsociaciónRef">{{ $t('Association_Line_Reference_Label') }}</label>
                            <input class="class4" type="text" id="AsociaciónRef"
                                :placeholder="$t('Association_Line_Reference_Placeholder')">
                        </div>
            ...
            <div class="table-container">
                <table class="class1">
                    ...
                    <tbody>
                                ...
                                <div v-if="showModal1" class="modal1-overlay">
                                    <div class="modal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="class4" type="text" id="AsociaciónName"
                                                :placeholder="$t('Prime_Saving_Placeholder')">
                                        </div>
                        ...
                        <!-- Repeat <tr>...</tr> for additional rows as required -->
                    </tbody>
                </table>
            </div>
        </div>
